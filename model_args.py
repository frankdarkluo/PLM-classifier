...
def get_args():
    ...
    parser.add_argument('--topk', default=40, type=int,help="top-k words in masked out word prediction")
    ...
    parser.add_argument("--style_weight", type=int, default=6, help='style')
